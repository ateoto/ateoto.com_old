...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Power.keywords'
        db.delete_column('character_builder_power', 'keywords')

        # Adding field 'Power.action_type'
        db.add_column('character_builder_power', 'action_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['character_builder.ActionType']),
                      keep_default=False)

        # Adding field 'Power.range_type'
        db.add_column('character_builder_power', 'range_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['character_builder.PowerRange']),
                      keep_default=False)

        # Adding field 'Power.range_description'
        db.add_column('character_builder_power', 'range_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Power.usage'
        db.add_column('character_builder_power', 'usage',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['character_builder.PowerUsage']),
                      keep_default=False)

        # Adding field 'Power.requirement'
        db.add_column('character_builder_power', 'requirement',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Power.hit_modifier'
        db.add_column('character_builder_power', 'hit_modifier',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['character_builder.Ability'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Power.secondary_attack'
        db.add_column('character_builder_power', 'secondary_attack',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Power.secondary_hit'
        db.add_column('character_builder_power', 'secondary_hit',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Power.secondary_hit_modifier'
        db.add_column('character_builder_power', 'secondary_hit_modifier',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='secondary_hit_modifier', null=True, to=orm['character_builder.Ability']),
                      keep_default=False)

        # Adding field 'Power.secondary_target'
        db.add_column('character_builder_power', 'secondary_target',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Power.sustain'
        db.add_column('character_builder_power', 'sustain',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Power.sustain_action'
        db.add_column('character_builder_power', 'sustain_action',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sustain_action', null=True, to=orm['character_builder.ActionType']),
                      keep_default=False)
        ...
        # Changing field 'Power.hit'
        db.alter_column('character_builder_power', 'hit', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Power.target'
        db.alter_column('character_builder_power', 'target', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Power.effect'
        db.alter_column('character_builder_power', 'effect', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Power.attack'
        db.alter_column('character_builder_power', 'attack', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Power.flavor'
        db.alter_column('character_builder_power', 'flavor', self.gf('django.db.models.fields.TextField')(default=1))

        # Changing field 'Power.miss'
        db.alter_column('character_builder_power', 'miss', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Power.special'
        db.alter_column('character_builder_power', 'special', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Power.name'
        db.alter_column('character_builder_power', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
        # Adding field 'Race.playable'
        db.add_column('character_builder_race', 'playable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Role.flavor'
        db.add_column('character_builder_role', 'flavor',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Power.keywords'
        db.add_column('character_builder_power', 'keywords',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Power.action_type'
        db.delete_column('character_builder_power', 'action_type_id')

        # Deleting field 'Power.range_type'
        db.delete_column('character_builder_power', 'range_type_id')

        # Deleting field 'Power.range_description'
        db.delete_column('character_builder_power', 'range_description')

        # Deleting field 'Power.usage'
        db.delete_column('character_builder_power', 'usage_id')

        # Deleting field 'Power.requirement'
        db.delete_column('character_builder_power', 'requirement')

        # Deleting field 'Power.hit_modifier'
        db.delete_column('character_builder_power', 'hit_modifier_id')

        # Deleting field 'Power.secondary_attack'
        db.delete_column('character_builder_power', 'secondary_attack')

        # Deleting field 'Power.secondary_hit'
        db.delete_column('character_builder_power', 'secondary_hit')

        # Deleting field 'Power.secondary_hit_modifier'
        db.delete_column('character_builder_power', 'secondary_hit_modifier_id')

        # Deleting field 'Power.secondary_target'
        db.delete_column('character_builder_power', 'secondary_target')

        # Deleting field 'Power.sustain'
        db.delete_column('character_builder_power', 'sustain')

        # Deleting field 'Power.sustain_action'
        db.delete_column('character_builder_power', 'sustain_action_id')
        ...
        # Changing field 'Power.hit'
        db.alter_column('character_builder_power', 'hit', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Power.target'
        db.alter_column('character_builder_power', 'target', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Power.effect'
        db.alter_column('character_builder_power', 'effect', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Power.attack'
        db.alter_column('character_builder_power', 'attack', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Power.flavor'
        db.alter_column('character_builder_power', 'flavor', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Power.miss'
        db.alter_column('character_builder_power', 'miss', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Power.special'
        db.alter_column('character_builder_power', 'special', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Power.name'
        db.alter_column('character_builder_power', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
        # Deleting field 'Race.playable'
        db.delete_column('character_builder_race', 'playable')

        # Deleting field 'Role.flavor'
        db.delete_column('character_builder_role', 'flavor')
